...
>
> **Last verified August 11, 2026** — `npm run gate` green (318 tests, 56 provenance cases, 5/5 prompt goldens byte-identical), `npm run corpus:probe` green (self-match 1.0000, 9 accounts in 586ms, 7/7 claims, 162 English accounts, 16 non-English dropped). All Sprint 0 code is on `origin/staging` through **`dd2be6d`**.
