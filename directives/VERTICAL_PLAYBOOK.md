...
>
> **The one meta-rule:** the engine defaults to the EXISTING verticals everywhere. Every list below is a place where a new domain must *opt in* — anything you skip doesn't break, it silently behaves like MasteryTV or Relatti in front of the new domain's users.
