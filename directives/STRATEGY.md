...
|:--|:--|:--|:--|:--|:--|
| **1 — NOW** | Relationship Coaching (**Relatti**) | `relatti.com/{couples,engaged,married,…}` | **The partner** | Light–Moderate (compatibility/dyad plumbing already exists) | Beachhead + retention-thesis test |
| **2 — Next** | Career Transition Coaching | `mycareercoach.com/{laidoff,downsized,ineedmoremoney,…}` | **The deadline / job search** | Moderate (cohort grouping + aggregate dashboards) | Build-to-sellable B2B revenue |
| **3 — Exit** | White-Label Platform | `growyourcoachingbusiness.com` | **The human coach** | Heavy (full multi-tenancy) | Sellable/acquirable asset |
