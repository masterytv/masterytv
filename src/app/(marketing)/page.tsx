    ...
    <main className="page" role="main">
      ...
      <footer className="footer">
        ...
        <div style={{ marginTop: "0.5rem", display: "flex", gap: "1.5rem", justifyContent: "center" }}>
          <Link href="/privacy" style={{ color: "var(--text-secondary)", fontSize: "0.8rem", textDecoration: "none" }}>
            Privacy Policy
          </Link>
          <Link href="/terms" style={{ color: "var(--text-secondary)", fontSize: "0.8rem", textDecoration: "none" }}>
            Terms of Service
          </Link>
        </div>
      </footer>
