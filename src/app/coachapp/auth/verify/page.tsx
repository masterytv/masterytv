  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      ...
      <div className="glass relative w-full max-w-md rounded-2xl p-8 text-center">
        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-[rgba(96,99,238,0.1)]">
        ...
        {status === "error" && (
          <>
            ...
            <button
              ...
              className="mt-6 rounded-lg bg-gradient-to-r from-[#a3a6ff] to-[#6063ee] px-6 py-2.5 text-sm font-medium text-white hover:opacity-90 transition-opacity"
            >
              Back to Login
            </button>
          </>
