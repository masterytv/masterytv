...
export const IPIP50: InstrumentDef = {
  ...
  items: [
    ...
    { index: 29, text: 'I get upset easily' },
    ...
    { index: 39, text: 'I have frequent mood swings' },
    { index: 40, text: 'I use difficult words' },
    ...
    { index: 48, text: 'I am exacting in my work' },
    { index: 49, text: 'I often feel blue' },
